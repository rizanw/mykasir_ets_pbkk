                ...
                <div class="container-fluid">
                    ...
                    <div class="card mb-3">
                        <div class="card-header">
                            ...
                            <a href="<?php echo site_url('dashboard/products/') ?>"><i class="fas fa-arrow-left"></i>
                                Back</a>
                        </div>
                        <div class="card-body">
							...
							oleh controller tempat vuew ini digunakan. Yakni index.php/dashboard/products/edit/ID --->
